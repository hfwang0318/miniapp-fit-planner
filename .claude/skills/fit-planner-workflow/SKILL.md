...
加载 `superpowers:finishing-a-development-branch`。审阅所有输出 → 更新 `docs/changelog.md` → 验证 Git 状态（详见 `references/quality-gates.md`）→ 生成提交信息 → 合并到 `main`。输出按 orchestrator.md 中的模板。
